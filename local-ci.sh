...
echo -e "${YELLOW}[1/4] Checking static web asset integrity...${NC}"
...
echo -e "${YELLOW}[2/4] Verifying environment variable configuration...${NC}"
...
# Step 3: TypeScript Compilation Guard (Docker Builder Test)
echo -e "${YELLOW}[3/4] Running TypeScript compiler check inside Docker...${NC}"
